<nav class="flex-1 flex flex-col gap-6 w-full px-2">
    <a href="{{ route('pos.index') }}"
        ...
        <svg id='Money_Cashier_24' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'
    ...
    <button @click="showCloseShift = true"
        class="w-full mt-4 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-all">
