<div x-show="isCartOpen" x-transition
     class="fixed bottom-0 left-0 right-0 z-50 max-w-md mx-auto bg-white rounded-t-2xl overflow-hidden shadow-lg h-[85vh] flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-4">
        <div class="bg-yellow-50 p-4 rounded-xl border border-yellow-100">
            ...
            <p class="text-xs text-gray-500 mt-1">Nama ini akan dipanggil oleh kasir.</p>
        </div>

        <template x-if="cart.length === 0">
            <div class="text-center text-gray-500 mt-4">Belum ada menu yang dipilih</div>
        </template>
